/datum/job/shelltooth/security
	title = "Security Officer"
	alt_titles = list("Warden","Scout")
	supervisors = "the Head of Security"
	spawn_positions = 1
	total_positions = 2
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/security
...
/datum/job/shelltooth/detective
	title = "Detective"
	alt_titles = list("Inspector")
	supervisors = "Justice... and the Trademaster"
	spawn_positions = 1
	total_positions = 1
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/detective
	department_types = list(/decl/department/security)
...
/datum/job/shelltooth/security/head
	title = "Head of Security"
	supervisors = "the Captain"
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/security/head
	head_position = 1
