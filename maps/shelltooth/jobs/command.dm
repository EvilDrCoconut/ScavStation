...
/datum/job/shelltooth/captain/equip_job(var/mob/living/carbon/human/H, var/alt_title, var/datum/mil_branch/branch, var/datum/mil_rank/grade)
	. = ..()
	if(H)
		H.verbs |= /mob/proc/freetradeunion_rename_company

/datum/job/shelltooth/captain/get_access()
...
/datum/job/shelltooth/hop
	title = "Head of Personnel"
	alt_titles = list("Patriarch of Personnel","Lieutenant")
	supervisors = "the Captain"
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/hop
	head_position = 1
