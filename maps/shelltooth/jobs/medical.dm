/datum/job/shelltooth/doctor
	...
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/doctor
	minimal_player_age = 3
	event_categories = list(ASSIGNMENT_MEDICAL)

/datum/job/shelltooth/doctor/head
	...
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/doctor/head
