/datum/job/shelltooth/scientist
	title = "Researcher"
	...
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/scientist
...
/datum/job/shelltooth/scientist/head
	title = "Research Director"
	supervisors = "the Captain"
	spawn_positions = 1
	total_positions = 1
	alt_titles = list("Head Researcher", "Chief Researcher", "Patriarch of Science")
	outfit_type = /decl/hierarchy/outfit/job/shelltooth/scientist/head
	min_skill = list(
		SKILL_LITERACY = SKILL_ADEPT,
		SKILL_COMPUTER = SKILL_BASIC,
