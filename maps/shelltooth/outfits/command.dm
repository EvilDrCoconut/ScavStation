...
/decl/hierarchy/outfit/job/shelltooth/captain/Initialize()
	. = ..()
...
/decl/hierarchy/outfit/job/shelltooth/hop
	name = "shelltooth - Job - Lieutenant"
