...
/obj/effect/overmap/visitable/sector/planetoid/exoplanet/grass_habitable
	name = "lush exoplanet"
	desc = "Planet with abundant flora and fauna."
	color = "#407c40"

/obj/effect/overmap/visitable/sector/planetoid/exoplanet/grass_habitable/get_surface_color()
...
/datum/level_data/planetoid/exoplanet/grass_habitable
	base_area           = /area/exoplanet/grass
	base_turf           = /turf/exterior/wildgrass
	exterior_atmosphere = null
	exterior_atmos_temp = null
	level_generators    = list(
		/datum/random_map/noise/exoplanet/grass_habitable
	)
...
/datum/planet_flora/random/grass_habitable
	flora_diversity = 6
	plant_colors    = list(
		"#215a00",
		"#195a47",
...
/datum/fauna_generator/grass_habitable
	fauna_types = list(
...
/datum/planetoid_data/random/grass_habitable
	habitability_class             = HABITABILITY_IDEAL
	atmosphere_gen_pressure_min    = 0.9 ATM
	atmosphere_gen_pressure_max    = 1.2 ATM
	atmosphere_gen_temperature_min = 20 CELSIUS  //Within liquid water/humanoid "comfort" range. Gets adjusted to default species.
	atmosphere_gen_temperature_max = 40 CELSIUS  //Within liquid water/humanoid "comfort" range. Gets adjusted to default species.
	surface_light_gen_level_min    = 0.25 //give a chance of twilight jungle
	surface_light_gen_level_max    = 0.75
	flora                          = /datum/planet_flora/random/grass_habitable
	fauna                          = /datum/fauna_generator/grass_habitable
...
/datum/planetoid_data/random/grass_habitable/generate_habitability()
...
///Map template for generating a grass_habitable exoplanet
/datum/map_template/planetoid/random/exoplanet/grass_habitable
	name                       = "lush exoplanet"
	planetoid_data_type        = /datum/planetoid_data/random/grass_habitable
	overmap_marker_type        = /obj/effect/overmap/visitable/sector/planetoid/exoplanet/grass_habitable
	template_parent_type       = /datum/map_template/planetoid/random/exoplanet
	level_data_type            = /datum/level_data/planetoid/exoplanet/grass_habitable
...
///Map generator for the grass_habitable exoplanet surface
/datum/random_map/noise/exoplanet/grass_habitable
...
/area/exoplanet/grass_habitable
	base_turf = /turf/exterior/wildgrass
	ambience  = list(
